...
const styles = StyleSheet.create({
  ...
  ghead: { color: C.brassMuted, fontSize: 10, fontWeight: '800', letterSpacing: 1, textAlign: 'center' },
  roundLabel: { color: C.textMuted, fontSize: 11, fontWeight: '800', letterSpacing: 1 },
  roundMin: { color: C.textGhost, fontSize: 10, marginTop: 1 },
  roundScore: { color: C.text, fontSize: 19, fontWeight: '800' },
  roundBits: { color: C.textFaint, fontSize: 10, marginTop: 1 },
  totalLabel: { color: C.text, fontSize: 12, fontWeight: '800', letterSpacing: 1.2 },
  totalScore: { color: C.brass, fontSize: 26, fontWeight: '800' },

  section: { color: C.brassMuted, fontSize: 11, fontWeight: '800', letterSpacing: 1.4, marginTop: 24, marginBottom: 8 },
  sups: { flexDirection: 'row', flexWrap: 'wrap', gap: 10 },
  sup: {
    flexGrow: 1, flexBasis: '45%', backgroundColor: C.surface, borderRadius: 12,
    borderWidth: 1, borderColor: C.border, padding: 12,
  },
  supTitle: { color: C.brassMuted, fontSize: 10, fontWeight: '800', letterSpacing: 1 },
